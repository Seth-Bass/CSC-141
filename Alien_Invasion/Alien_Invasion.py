...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.background = Background(self, "images/space.bmp", scroll_speed=10)
    ...
    def _check_events(self):
         #Respond for ketboard and mouse events.
    ...
    def _check_fleet_edges(self):
        '''Respond appropriatiately if any aliens have reached an edge.'''
    ...
    def _change_fleet_direction(self):
        '''Drop teh entire fleet and change the direction fo the fleet.'''
        for alien in self.aliens.sprites():
